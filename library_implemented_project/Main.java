...
public class Main implements IMainListener {
	...
	public BookDAO bookda=new BookDAO();
	...
	public static String nm,nm1,nm2,nm3;
	public Main() {
	...
	public void setTestData2()
	{
		...
		bookda.addBook("auth1","title1","clln1");
		bookda.addBook("authorX"," titleX"," callNoX");
		bookda.addBook("authorP"," titleQ"," callNoR");
